...
function setup() {
  ...
  playerArcher = new PlayerArcher(width - 750,playerBase.body.position.y - 180,120,120)
  //Create an arrow Object
  
  arrow = new PlayerArrow(playerArcher.body.position.x + 50,playerArcher.body.position.y,60,10)
